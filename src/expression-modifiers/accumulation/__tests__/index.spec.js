        ...
        describe('Full range', () => {
          ...
          describe('showExcludedValues = true', () => {
            ...
            it('should generate correct expression when dimension is non-numeric', () => {
              ...
              expect(outputExpression).to.equal('RangeSum(Above(If(Count([$(=Replace(GetObjectField(0),\']\',\']]\'))]) > 0,  (　Sum(Sales)　)  + Sum({1<[$(=Replace(GetObjectField(0),\']\',\']]\'))]={"=Only({1}[$(=Replace(GetObjectField(0),\']\',\']]\'))])>=\'$(=MinString([$(=Replace(GetObjectField(0),\']\',\']]\'))]))\' and Only({1}[$(=Replace(GetObjectField(0),\']\',\']]\'))])<=\'$(=MaxString([$(=Replace(GetObjectField(0),\']\',\']]\'))]))\'"}>}0), 0), 0, RowNo()))');
            });
          });
        ...
        describe('Custom range', () => {
          ...
          describe('showExcludedValues = true', () => {
            ...
            it('should generate correct expression when dimension is non-numeric', () => {
              ...
              expect(outputExpression).to.equal('RangeSum(Above(If(Count([$(=Replace(GetObjectField(0),\']\',\']]\'))]) > 0,  (　Sum(Sales)　)  + Sum({1<[$(=Replace(GetObjectField(0),\']\',\']]\'))]={"=Only({1}[$(=Replace(GetObjectField(0),\']\',\']]\'))])>=\'$(=MinString([$(=Replace(GetObjectField(0),\']\',\']]\'))]))\' and Only({1}[$(=Replace(GetObjectField(0),\']\',\']]\'))])<=\'$(=MaxString([$(=Replace(GetObjectField(0),\']\',\']]\'))]))\'"}>}0), 0), 0, 6))');
            });
          });
            ...
            describe('Full range', () => {
              ...
              describe('showExcludedValues = true', () => {
                ...
                it('should generate correct expression when dimension is non-numeric', () => {
                  ...
                  expect(outputExpression).to.equal('Sum({1<[$(=Replace(GetObjectField(0),\']\',\']]\'))]={"=Only({1}[$(=Replace(GetObjectField(0),\']\',\']]\'))])>=\'$(=MinString([$(=Replace(GetObjectField(0),\']\',\']]\'))]))\' and Only({1}[$(=Replace(GetObjectField(0),\']\',\']]\'))])<=\'$(=MaxString([$(=Replace(GetObjectField(0),\']\',\']]\'))]))\'"},[$(=Replace(GetObjectField(1),\']\',\']]\'))]={"=Only({1}[$(=Replace(GetObjectField(1),\']\',\']]\'))])>=\'$(=MinString([$(=Replace(GetObjectField(1),\']\',\']]\'))]))\' and Only({1}[$(=Replace(GetObjectField(1),\']\',\']]\'))])<=\'$(=MaxString([$(=Replace(GetObjectField(1),\']\',\']]\'))]))\'"}>}Aggr(RangeSum(Above(Total If(Count([$(=Replace(GetObjectField(0),\']\',\']]\'))]) * Count([$(=Replace(GetObjectField(1),\']\',\']]\'))]) > 0,  (　Sum(Sales)　)  + Sum({1<[$(=Replace(GetObjectField(0),\']\',\']]\'))]={"=Only({1}[$(=Replace(GetObjectField(0),\']\',\']]\'))])>=\'$(=MinString([$(=Replace(GetObjectField(0),\']\',\']]\'))]))\' and Only({1}[$(=Replace(GetObjectField(0),\']\',\']]\'))])<=\'$(=MaxString([$(=Replace(GetObjectField(0),\']\',\']]\'))]))\'"},[$(=Replace(GetObjectField(1),\']\',\']]\'))]={"=Only({1}[$(=Replace(GetObjectField(1),\']\',\']]\'))])>=\'$(=MinString([$(=Replace(GetObjectField(1),\']\',\']]\'))]))\' and Only({1}[$(=Replace(GetObjectField(1),\']\',\']]\'))])<=\'$(=MaxString([$(=Replace(GetObjectField(1),\']\',\']]\'))]))\'"}>}0), 0), 0, RowNo(Total))), [$(=Replace(GetObjectField(1),\']\',\']]\'))], [$(=Replace(GetObjectField(0),\']\',\']]\'))]))');
                });
              });
            ...
            describe('Custom range', () => {
              ...
              describe('showExcludedValues = true', () => {
                ...
                it('should generate correct expression when dimension is non-numeric', () => {
                  ...
                  expect(outputExpression).to.equal('Sum({1<[$(=Replace(GetObjectField(0),\']\',\']]\'))]={"=Only({1}[$(=Replace(GetObjectField(0),\']\',\']]\'))])>=\'$(=MinString([$(=Replace(GetObjectField(0),\']\',\']]\'))]))\' and Only({1}[$(=Replace(GetObjectField(0),\']\',\']]\'))])<=\'$(=MaxString([$(=Replace(GetObjectField(0),\']\',\']]\'))]))\'"},[$(=Replace(GetObjectField(1),\']\',\']]\'))]={"=Only({1}[$(=Replace(GetObjectField(1),\']\',\']]\'))])>=\'$(=MinString([$(=Replace(GetObjectField(1),\']\',\']]\'))]))\' and Only({1}[$(=Replace(GetObjectField(1),\']\',\']]\'))])<=\'$(=MaxString([$(=Replace(GetObjectField(1),\']\',\']]\'))]))\'"}>}Aggr(RangeSum(Above(Total If(Count([$(=Replace(GetObjectField(0),\']\',\']]\'))]) * Count([$(=Replace(GetObjectField(1),\']\',\']]\'))]) > 0,  (　Sum(Sales)　)  + Sum({1<[$(=Replace(GetObjectField(0),\']\',\']]\'))]={"=Only({1}[$(=Replace(GetObjectField(0),\']\',\']]\'))])>=\'$(=MinString([$(=Replace(GetObjectField(0),\']\',\']]\'))]))\' and Only({1}[$(=Replace(GetObjectField(0),\']\',\']]\'))])<=\'$(=MaxString([$(=Replace(GetObjectField(0),\']\',\']]\'))]))\'"},[$(=Replace(GetObjectField(1),\']\',\']]\'))]={"=Only({1}[$(=Replace(GetObjectField(1),\']\',\']]\'))])>=\'$(=MinString([$(=Replace(GetObjectField(1),\']\',\']]\'))]))\' and Only({1}[$(=Replace(GetObjectField(1),\']\',\']]\'))])<=\'$(=MaxString([$(=Replace(GetObjectField(1),\']\',\']]\'))]))\'"}>}0), 0), 0, 6)), [$(=Replace(GetObjectField(1),\']\',\']]\'))], [$(=Replace(GetObjectField(0),\']\',\']]\'))]))');
                });
              });
            ...
            describe('Full range', () => {
              ...
              describe('showExcludedValues = true', () => {
                ...
                it('should generate correct expression when dimension is non-numeric', () => {
                  ...
                  expect(outputExpression).to.equal('Sum({1<[$(=Replace(GetObjectField(0),\']\',\']]\'))]={"=Only({1}[$(=Replace(GetObjectField(0),\']\',\']]\'))])>=\'$(=MinString([$(=Replace(GetObjectField(0),\']\',\']]\'))]))\' and Only({1}[$(=Replace(GetObjectField(0),\']\',\']]\'))])<=\'$(=MaxString([$(=Replace(GetObjectField(0),\']\',\']]\'))]))\'"},[$(=Replace(GetObjectField(1),\']\',\']]\'))]={"=Only({1}[$(=Replace(GetObjectField(1),\']\',\']]\'))])>=\'$(=MinString([$(=Replace(GetObjectField(1),\']\',\']]\'))]))\' and Only({1}[$(=Replace(GetObjectField(1),\']\',\']]\'))])<=\'$(=MaxString([$(=Replace(GetObjectField(1),\']\',\']]\'))]))\'"}>}Aggr(RangeSum(Above(If(Count([$(=Replace(GetObjectField(0),\']\',\']]\'))]) * Count([$(=Replace(GetObjectField(1),\']\',\']]\'))]) > 0,  (　Sum(Sales)　)  + Sum({1<[$(=Replace(GetObjectField(0),\']\',\']]\'))]={"=Only({1}[$(=Replace(GetObjectField(0),\']\',\']]\'))])>=\'$(=MinString([$(=Replace(GetObjectField(0),\']\',\']]\'))]))\' and Only({1}[$(=Replace(GetObjectField(0),\']\',\']]\'))])<=\'$(=MaxString([$(=Replace(GetObjectField(0),\']\',\']]\'))]))\'"},[$(=Replace(GetObjectField(1),\']\',\']]\'))]={"=Only({1}[$(=Replace(GetObjectField(1),\']\',\']]\'))])>=\'$(=MinString([$(=Replace(GetObjectField(1),\']\',\']]\'))]))\' and Only({1}[$(=Replace(GetObjectField(1),\']\',\']]\'))])<=\'$(=MaxString([$(=Replace(GetObjectField(1),\']\',\']]\'))]))\'"}>}0), 0), 0, RowNo())), [$(=Replace(GetObjectField(1),\']\',\']]\'))], [$(=Replace(GetObjectField(0),\']\',\']]\'))]))');
                });
              });
            ...
            describe('Custom range', () => {
              ...
              describe('showExcludedValues = true', () => {
                ...
                it('should generate correct expression when dimension is non-numeric', () => {
                  ...
                  expect(outputExpression).to.equal('Sum({1<[$(=Replace(GetObjectField(0),\']\',\']]\'))]={"=Only({1}[$(=Replace(GetObjectField(0),\']\',\']]\'))])>=\'$(=MinString([$(=Replace(GetObjectField(0),\']\',\']]\'))]))\' and Only({1}[$(=Replace(GetObjectField(0),\']\',\']]\'))])<=\'$(=MaxString([$(=Replace(GetObjectField(0),\']\',\']]\'))]))\'"},[$(=Replace(GetObjectField(1),\']\',\']]\'))]={"=Only({1}[$(=Replace(GetObjectField(1),\']\',\']]\'))])>=\'$(=MinString([$(=Replace(GetObjectField(1),\']\',\']]\'))]))\' and Only({1}[$(=Replace(GetObjectField(1),\']\',\']]\'))])<=\'$(=MaxString([$(=Replace(GetObjectField(1),\']\',\']]\'))]))\'"}>}Aggr(RangeSum(Above(If(Count([$(=Replace(GetObjectField(0),\']\',\']]\'))]) * Count([$(=Replace(GetObjectField(1),\']\',\']]\'))]) > 0,  (　Sum(Sales)　)  + Sum({1<[$(=Replace(GetObjectField(0),\']\',\']]\'))]={"=Only({1}[$(=Replace(GetObjectField(0),\']\',\']]\'))])>=\'$(=MinString([$(=Replace(GetObjectField(0),\']\',\']]\'))]))\' and Only({1}[$(=Replace(GetObjectField(0),\']\',\']]\'))])<=\'$(=MaxString([$(=Replace(GetObjectField(0),\']\',\']]\'))]))\'"},[$(=Replace(GetObjectField(1),\']\',\']]\'))]={"=Only({1}[$(=Replace(GetObjectField(1),\']\',\']]\'))])>=\'$(=MinString([$(=Replace(GetObjectField(1),\']\',\']]\'))]))\' and Only({1}[$(=Replace(GetObjectField(1),\']\',\']]\'))])<=\'$(=MaxString([$(=Replace(GetObjectField(1),\']\',\']]\'))]))\'"}>}0), 0), 0, 6)), [$(=Replace(GetObjectField(1),\']\',\']]\'))], [$(=Replace(GetObjectField(0),\']\',\']]\'))]))');
                });
              });
            ...
            describe('Full range', () => {
              ...
              describe('showExcludedValues = true', () => {
                ...
                it('should generate correct expression when dimension is non-numeric', () => {
                  ...
                  expect(outputExpression).to.equal('RangeSum(Above(Total If(Count([$(=Replace(GetObjectField(0),\']\',\']]\'))]) * Count([$(=Replace(GetObjectField(1),\']\',\']]\'))]) > 0,  (　Sum(Sales)　)  + Sum({1<[$(=Replace(GetObjectField(0),\']\',\']]\'))]={"=Only({1}[$(=Replace(GetObjectField(0),\']\',\']]\'))])>=\'$(=MinString([$(=Replace(GetObjectField(0),\']\',\']]\'))]))\' and Only({1}[$(=Replace(GetObjectField(0),\']\',\']]\'))])<=\'$(=MaxString([$(=Replace(GetObjectField(0),\']\',\']]\'))]))\'"},[$(=Replace(GetObjectField(1),\']\',\']]\'))]={"=Only({1}[$(=Replace(GetObjectField(1),\']\',\']]\'))])>=\'$(=MinString([$(=Replace(GetObjectField(1),\']\',\']]\'))]))\' and Only({1}[$(=Replace(GetObjectField(1),\']\',\']]\'))])<=\'$(=MaxString([$(=Replace(GetObjectField(1),\']\',\']]\'))]))\'"}>}0), 0), 0, RowNo(Total)))');
                });
              });
            ...
            describe('Custom range', () => {
              ...
              describe('showExcludedValues = true', () => {
                ...
                it('should generate correct expression when dimension is non-numeric', () => {
                  ...
                  expect(outputExpression).to.equal('RangeSum(Above(Total If(Count([$(=Replace(GetObjectField(0),\']\',\']]\'))]) * Count([$(=Replace(GetObjectField(1),\']\',\']]\'))]) > 0,  (　Sum(Sales)　)  + Sum({1<[$(=Replace(GetObjectField(0),\']\',\']]\'))]={"=Only({1}[$(=Replace(GetObjectField(0),\']\',\']]\'))])>=\'$(=MinString([$(=Replace(GetObjectField(0),\']\',\']]\'))]))\' and Only({1}[$(=Replace(GetObjectField(0),\']\',\']]\'))])<=\'$(=MaxString([$(=Replace(GetObjectField(0),\']\',\']]\'))]))\'"},[$(=Replace(GetObjectField(1),\']\',\']]\'))]={"=Only({1}[$(=Replace(GetObjectField(1),\']\',\']]\'))])>=\'$(=MinString([$(=Replace(GetObjectField(1),\']\',\']]\'))]))\' and Only({1}[$(=Replace(GetObjectField(1),\']\',\']]\'))])<=\'$(=MaxString([$(=Replace(GetObjectField(1),\']\',\']]\'))]))\'"}>}0), 0), 0, 6))');
                });
              });
            ...
            describe('Full range', () => {
              ...
              describe('showExcludedValues = true', () => {
                ...
                it('should generate correct expression when dimension is non-numeric', () => {
                  ...
                  expect(outputExpression).to.equal('RangeSum(Above(If(Count([$(=Replace(GetObjectField(0),\']\',\']]\'))]) * Count([$(=Replace(GetObjectField(1),\']\',\']]\'))]) > 0,  (　Sum(Sales)　)  + Sum({1<[$(=Replace(GetObjectField(0),\']\',\']]\'))]={"=Only({1}[$(=Replace(GetObjectField(0),\']\',\']]\'))])>=\'$(=MinString([$(=Replace(GetObjectField(0),\']\',\']]\'))]))\' and Only({1}[$(=Replace(GetObjectField(0),\']\',\']]\'))])<=\'$(=MaxString([$(=Replace(GetObjectField(0),\']\',\']]\'))]))\'"},[$(=Replace(GetObjectField(1),\']\',\']]\'))]={"=Only({1}[$(=Replace(GetObjectField(1),\']\',\']]\'))])>=\'$(=MinString([$(=Replace(GetObjectField(1),\']\',\']]\'))]))\' and Only({1}[$(=Replace(GetObjectField(1),\']\',\']]\'))])<=\'$(=MaxString([$(=Replace(GetObjectField(1),\']\',\']]\'))]))\'"}>}0), 0), 0, RowNo()))');
                });
              });
            ...
            describe('Custom range', () => {
              ...
              describe('showExcludedValues = true', () => {
                ...
                it('should generate correct expression when dimension is non-numeric', () => {
                  ...
                  expect(outputExpression).to.equal('RangeSum(Above(If(Count([$(=Replace(GetObjectField(0),\']\',\']]\'))]) * Count([$(=Replace(GetObjectField(1),\']\',\']]\'))]) > 0,  (　Sum(Sales)　)  + Sum({1<[$(=Replace(GetObjectField(0),\']\',\']]\'))]={"=Only({1}[$(=Replace(GetObjectField(0),\']\',\']]\'))])>=\'$(=MinString([$(=Replace(GetObjectField(0),\']\',\']]\'))]))\' and Only({1}[$(=Replace(GetObjectField(0),\']\',\']]\'))])<=\'$(=MaxString([$(=Replace(GetObjectField(0),\']\',\']]\'))]))\'"},[$(=Replace(GetObjectField(1),\']\',\']]\'))]={"=Only({1}[$(=Replace(GetObjectField(1),\']\',\']]\'))])>=\'$(=MinString([$(=Replace(GetObjectField(1),\']\',\']]\'))]))\' and Only({1}[$(=Replace(GetObjectField(1),\']\',\']]\'))])<=\'$(=MaxString([$(=Replace(GetObjectField(1),\']\',\']]\'))]))\'"}>}0), 0), 0, 6))');
                });
              });
